...
function crearEmpleadosGV(ss) {
  var h = ['alias','nombre','apellidos','dni','telefono','email','fechaAlta','contrato','tienda','franja','restriccion','color','horasGV','horasIS'];
  var r = [
    ...
    ['EDU','Eduardo','Gonzalez','56789012E','612005005','edu@kira.com','2020-04-20',30,'ambas','mananas','max-15','#2e7d32',30,12],
    ['DAVID','David','Rodriguez','67890123F','612006006','david@kira.com','2020-07-01',30,'ambas','rotativo','','#2c5aa0',30,12],
    ['LETI','Leticia','Jimenez','78901234G','612007007','leti@kira.com','2020-07-01',30,'ambas','rotativo','','#2c5aa0',30,12],
    ['SILVIA','Silvia','Hernandez','89012345H','612008008','silvia@kira.com','2021-02-15',30,'ambas','tardes','','#e65100',30,15],
    ['ALEX','Alejandro','Munoz','90123456I','612009009','alex@kira.com','2021-05-01',30,'ambas','cierre','','#6a1b9a',30,15],
    ['ABDEL','Abdel','Benali','01234567J','612010010','abdel@kira.com','2021-09-01',30,'ambas','cierre','','#6a1b9a',30,15],
    ['ANTONIO','Antonio','Serrano','11223344K','612011011','antonio@kira.com','2019-01-15',25,'ambas','descarga','solo-descarga','#2c5aa0',25,15],
    ['VANESA','Vanesa','Ortega','22334455L','612012012','vanesa@kira.com','2022-03-01',25,'ambas','mananas','','#2e7d32',25,18],
    ['MORILLA','Jose','Morilla','33445566M','612013013','morilla@kira.com','2022-06-15',25,'ambas','tardes','','#e65100',25,18],
...
function crearEmpleadosIS(ss) {
  var h = ['alias','nombre','apellidos','dni','telefono','email','fechaAlta','contrato','tienda','franja','restriccion','color'];
  var r = [
